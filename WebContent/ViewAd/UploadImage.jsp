					...
					<li><a href="#homeSubmenu1" data-toggle="collapse"
						...
						<ul class="collapse list-unstyled" id="homeSubmenu1">
							<li><a href="#125" id="125"><i class="fa fa-th-list"></i>
									Tất cả đề thi</a></li>
							<li><a href="#125" id="125"><i class="fa fa-plus-circle"></i>
									Thêm đề thi</a></li>
						</ul></li>
		...
		<div class="pagebody">
			<div class="page-body-container">
				...
				<div class="row">
					<div class="container">
						<div class="col-sm-8">
							<h5>Thêm hình ảnh cho bài viết:</h5>
							<form action="AdminUploadImage?idPost=${id}" method="post" enctype="multipart/form-data">
								<div class="custom-file">
									<input type="file" name="image" accept="image/x-png,image/gif,image/jpeg" class="form-control"
										style="height: 100px">
								</div>
								<input type="submit" value="Đăng bài viết" class="btn-readmore"
