...
<body>
	...
	<div class="container-wrapper">
		<div class="header-link">
			<div class="container">
				<a href="Foward">Trang chủ</a> <a href="#" class="active">/ Bài viết</a>
			</div>
		</div>
		<div class="post-list">
			<div class="container">
							...
							<c:if test="${numberpage == 1 && numberpage == maxpageid}">
								...
								<c:if test="${numberpage == 1 && numberpage != maxpageid}">
									...
									<li class="page-item"><a class="page-link"
										href="PostController?pageid=${numberpage+1}">Sau</a></li>
								</c:if>
								<c:if test="${numberpage == maxpageid && numberpage!=1}">
									<li class="page-item"><a class="page-link"
										href="PostController?pageid=${numberpage-1}">Trước</a></li>
