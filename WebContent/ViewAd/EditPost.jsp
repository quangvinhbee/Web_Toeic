		...
		<div class="left-sidebar" >
			<div class="side-bar"style="margin-left: 40px">
				<ul class="side-bar-menu">
					...
					<li class="active-menu"><a href="#homeSubmenu" data-toggle="collapse"
						aria-expanded="false" class="dropdown-toggle"><i
							class="fa fa-edit" style="font-size: 20px"></i> Bài Viết</a>
						<ul class="collapse list-unstyled" id="homeSubmenu">
							<li class="active-menu"><a href="AdminQuanLiPostFoward?pageid=1#123" id="123"><i
		...
		<div class="pagebody">
			<div class="page-body-container">
				<div class="page-body-header">
					<p>
						<i class="fa fa-edit" style="font-size: 20px"></i> Sửa bài
						viết
					</p>
				</div>
				<div class="row">
					<div class="container">
						<div class="col-sm-8">
							<form action="AdminPostEdit?postid=${post.getId()}" method="POST"
								...
								<div class="add-post-body">
									<div class="add-title">
										...
										<textarea maxlength="500" class="form-control" type="text"
											...
											required="" value="">${post.getTitle()}</textarea>
									</div>
									<div class="add-content">
										...
										<div class="widget-main no-padding">
											<textarea class="form-control" name="content"
												...
												style="width: 1018px;" value="">${post.getContent()}</textarea>
										</div>
									</div>
									<div class="add-description">
										...
										<textarea class="form-control" name="describe"
											...
											style="width: 1018px;" value="">${post.getDescribe()}</textarea>
									</div>
									<div class="add-button">
										<input type="submit" value="Cập nhật" class="btn-readmore"
											style="" />
									</div>
								</div>
							</form>
